    ...
    try {
      ...
      for (const task of tasksRes.data) {
        try {
          ...
          submissionsData[task.id] = subsRes.data[0] || null; // Student sees only their own
        } catch (error) {
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ color: '#6b7280', marginTop: '10px' }}>
                  ...
                  {isPastDeadline && !isSubmitted && (
                    <span className="badge badge-danger" style={{ marginLeft: '10px' }}>Past Deadline</span>
                  )}
              ...
              <div>
                ...
                {isSubmitted ? (
                  ...
                  <button
                    ...
                    disabled={isPastDeadline || !isUnlocked}
                  >
                    {isUnlocked ? 'Submit' : 'Locked'}
                  </button>
                )}
              </div>
            </div>
